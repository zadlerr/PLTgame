...
all : venture.native scompare.o input.o lib.o printbig2.o
...
scompare: scompare.c
	cc -o scompare -DBUILD_TEST scompare.c

input: input.c
	cc -o input -DBUILD_TEST input.c

lib: lib.c
	cc -o lib -DBUILD_TEST lib.c

printbig : printbig2.c
	cc -o printbig2 -DBUILD_TEST printbig2.c
